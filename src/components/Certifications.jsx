...
import { Award, ArrowUpRight, ShieldCheck, Code, Globe, Database, Cpu } from 'lucide-react';
              ...
              >
                <div>
                  <div className="flex items-start justify-between gap-2">
                    <div className="p-2 rounded-lg bg-primary/10 text-primary group-hover:bg-primary group-hover:text-base-100 transition-colors duration-300">
